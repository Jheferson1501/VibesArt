...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .streak-max { font-size: 0.78rem; color: var(--muted); text-align: right; }
        ...
        .monthly-emoji { font-size: 2rem; }
        .monthly-title { font-size: 0.78rem; color: var(--muted); text-transform: uppercase; letter-spacing: 0.08em; }
        .monthly-emotion { font-family: 'Playfair Display', serif; font-size: 1.3rem; }
        ...
        .intensity-dots { display: flex; gap: 2px; margin-top: 0.3rem; justify-content: flex-end; }
        .dot {
...
<div class="container">
    ...
    <div class="monthly-box" style="background:{{ $colorMensual }}11;border-color:{{ $colorMensual }}33;">
        <span class="monthly-emoji">{{ $emojiMensual }}</span>
        <div>
            <div class="monthly-title">Tu Vibe del mes</div>
            <div class="monthly-emotion" style="color:{{ $colorMensual }};">
